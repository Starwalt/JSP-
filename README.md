...
<header>
  <div class="n-header">
    <div class="headerLeft">
      ...
      <!-- <div class="logo2">
        <a href="/"><img src="image/sandy-sb-logo.jpg" alt="logo" /></a>
      </div> -->
    </div>
    <div class="headerRight">
      <div class="nav-home d-flex justify-content-end">
        <div class="insurance-menu"><a href="http://www.sandysanthosh.github.in">Contact</a></div>
        <div class="right">
                        <div class="bg">
                            <ul class="nav-right">
      ...
      <div class="nav-wrap">
        <div class="mobileIcon">â˜° Menu</div>
